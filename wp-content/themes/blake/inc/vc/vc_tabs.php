...
foreach ( $tab_titles as $tab ) {
	...
	if(isset($tab_atts['title'])) {
		$tabs_nav .= '<li'.(($counter === 0) ? ' class="active"' : '').'><a href="#tab-' . ( isset( $tab_atts['tab_id'] ) ? $tab_atts['tab_id'] : sanitize_title( $tab_atts['title'] ) ) . '" data-toggle="tab"><span>' . wp_kses_post($tab_atts['title']) . '</span></a></li>';
	}
	$counter++;
}
$tabs_nav .= '</ul>';
...
$output .= '<div class="blake-wrapper tab-container">';
