...
require $_POST['templatepath'].'wp-content/plugins/blake_custom_post_types/lib/tmhOAuth.php';
...
class ezTweet {
	...
	public function __construct() {
		...
		$this->lib = $_POST['templatepath'].'wp-content/plugins/blake_custom_post_types/lib/';
